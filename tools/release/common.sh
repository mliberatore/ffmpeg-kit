...
export IOS_LTS_OPTIONS="--disable-armv7s --disable-i386 --disable-arm64 --disable-x86-64 --disable-arm64e --disable-arm64-mac-catalyst --disable-x86-64-mac-catalyst --lts --enable-ios-audiotoolbox --enable-ios-bzip2 --enable-ios-libiconv --enable-ios-videotoolbox --enable-ios-zlib"
